...
import 'package:tourisme_flutter/features/touriste/reservation/pages/reservation_form.dart';
import 'package:tourisme_flutter/features/touriste/reservation/providers/reservation_provider.dart';


// ou pages/paiement/paiement_test_page.dart
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        title: 'Tourisme – Tests reservation',
        home: ReservationFormPage(), // page de test
      ),
    );
  }
}
